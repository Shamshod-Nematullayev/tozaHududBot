...
export const getAllPachka = async (req, res, next) => {
  try {
...
export const getElementsPachka = async (req, res, next) => {
  try {
...
export const createNewPachka = async (req, res, next) => {
  try {
...
export const updatePachkaById = async (req, res, next) => {
  try {
...
export const deletePachkaById = async (req, res, next) => {
  try {
    const pachka = await SudAktPachka.findById(req.params.pachka_id);
