...
export const getAbonentDHJByAbonentId = async (req, res) => {
  try {
...
export const getAbonentActs = async (req, res) => {
  try {
    const { page = 0, limit = 100 } = req.query;
...
export const createResidentAct = async (req, res) => {
  try {
    const {
...
export const duplicateActFromRequest = async (req, res) => {
  try {
...
export const getActiveMfy = async (req, res) => {
  try {
...
export const createDublicateAct = async (req, res) => {
  try {
...
export const sendAbonentsListToTelegram = async (req, res) => {
  try {
...
export const getMfyById = async (req, res) => {
  try {
...
export const getAbonentDataByLicshet = async (req, res) => {
  try {
...
export const getAbonentsByMfyIdController = async (req, res) => {
  try {
...
export const getAbonentsByMfyIdExcel = async (req, res) => {
  try {
...
export const transferMoneyBetweenResidents = async (req, res) => {
  const tozaMakonApi = createTozaMakonApi(req.user.companyId);
  const createdActs = [];
