...
export const getCourtCaseBySudAktId = async (req, res) => {
  try {
...
export const getOneSudAkt = async (req, res) => {
  try {
...
export const searchByLicshetSudakt = async (req, res) => {
  try {
...
export const createSudAriza = async (req, res) => {
  try {
    const sudAkt = await SudAkt.findById(req.params._id);
    if (!sudAkt) {
...
export const getDebitorAbonents = async (req, res) => {
  try {
...
export const getDebitorAbonentsExcel = async (req, res) => {
  try {
    const { companyId } = req.user;
