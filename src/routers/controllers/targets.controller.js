...
export const createDocumentTargets = async (req, res) => {
  try {
...
export const signDocumentTargets = async (req, res) => {
  try {
...
export const getDocumentTargetsById = async (req, res) => {
  try {
...
export const getDocumentTargets = async (req, res) => {
  try {
    const {
      page = 1,
      limit = 30,
...
export const cancelTargetById = async (req, res) => {
  try {
