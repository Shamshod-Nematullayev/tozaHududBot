...
import abonentsRouter from './abonents.route.js';
...
mainRouter.use('/bildirgilar', allowRoles(['admin', 'yurist']), bildirgilarRouter);
...
mainRouter.use('/abonents', allowRoles(['admin', 'billing']), abonentsRouter);
...
mainRouter.use('/automobiles', allowRoles(['admin', 'gps', 'billing']), automobilesRouter);
