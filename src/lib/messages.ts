export const messages = {
  ...
  adminDone: "Siz adminga aylandingiz. Vazifangizni vijdonan ado etishingizni so'rab qolgan bo'lardim",
  ...
  ogohlantirishKiriting: "Nima uchun ushbu so'rov bekor qilinyapti? Ogohlantirish bo'lsa marhamat",
  ...
  biggierMaxLength: 'Izohdagi belgilar soni 300 ta dan oshib ketdi qisqaroq izoh kiriting!!',
  chooseMenu: "O'zingizga kerakli bo'limni tanlang!",
  chooseLanguage: "O'zingizga qulay alifboni tanlang",
  choosedLang: 'Til tanlandi',
  heyAdmin: 'Hush kelibsiz hurmatli janob. Nima vazifani bajarish kerak?',
  chooseIncomeType: 'Hisobot turini tanlang!',
  notExcelFile: 'Bu excel fayl emas',
  enterIncomeReport: "Hisobot faylini yuboring! Excelda billing tizimidan chiqgan faylni o'zgartirmasdan yuboring",
