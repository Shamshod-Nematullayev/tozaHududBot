...
async function nazoratchigaBiriktirilganMahallalar(inspector_id) {
...
const keyboards = {
  ...
  adminKeyboard: Markup.keyboard([
    ["👨‍💻 Ish maydoni", "OGOHLANTIRISH XATLARI IMPORT"],
  ...
  kiril: {
    ...
    editTypes: createInlineKeyboard([
      [
        ...
        ["Кўча/қишлоқ", "changeAbonentStreet"],
      ],
      [
    ...
    adminKeyboard: Markup.keyboard([
      ["👨‍💻 Иш майдони", "OGOHLANTIRISH XATLARI IMPORT"],
      ["ExportWarningLettersZip", "ExportAbonentCards"],
      ["pochtaHarajatiniTekshirishScene"],
    ]),
    adminWorkSpace: createInlineKeyboard([
