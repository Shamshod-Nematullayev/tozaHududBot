...
module.exports.keyboards = {
  lotin: {
    ...
    adminWorkSpace: Markup.inlineKeyboard([
      [
        Markup.button.callback("Bildirish xati kiritish", "add_notification"),
        Markup.button.callback("Abonent rasmi", "show_abonent_pic"),
      ],
      [
        Markup.button.callback("OX generation", "generate_alert_letter"),
      ...
      [Markup.button.callback("O'lim guvohnomasi ijro", "confirm_game_over")],
      [Markup.button.callback("Reja belgilash", "import_plan_for_inspectors")],
      [
        Markup.button.callback("Viloyat LOGIN", "CHARGE_VILOYAT_LOGIN"),
        Markup.button.callback("Tushum mfy", "mfy_income_report"),
      ],
      [
        Markup.button.callback(
      ...
      [Markup.button.callback("MFY telegram guruhi", "connect_mfy_tg_group")],
    ]),
  },
  kiril: {
    mainKeyboard: Markup.keyboard([
    ...
    adminWorkSpace: Markup.inlineKeyboard([
      [
        Markup.button.callback("Билдириш хати киритиш", "add_notification"),
