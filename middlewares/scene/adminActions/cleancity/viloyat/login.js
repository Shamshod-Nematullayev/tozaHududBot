...
const loginCleanCityViloyatScene = new Scenes.WizardScene(
  "login_clean_city_viloyat",
  (ctx) => {
    try {
...
loginCleanCityViloyatScene.enter(enteredCallback);

module.exports = { loginCleanCityViloyatScene };
